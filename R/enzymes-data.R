...
#' \tabular{ll}{
#' Patient \tab Patient ID\cr
#' Group \tab Four diagnostic groups were considered: acute viral hepatitis (1), persistent chronic hepatitis (2), aggressive chronic hepatitis (3) and post-necrotic cirrhosis (4). \cr
#' AST   \tab Aspartate aminotransferase (U/L) \cr
#' ALT   \tab Alanine aminotransferase (U/L) \cr
#' GLDH  \tab Glutamate dehydrogenase (U/L)\cr
#' OCT   \tab Ornithine carbamyltransferase (U/L)
#'     }
